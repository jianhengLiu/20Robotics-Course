...
% 通过三球面方程联立求得q点
syms x y z real;
eq1=-cos(theta2)*sin(theta1)*(l1 + l2 + theta3)==x;
eq2=cos(theta1)*cos(theta2)*(l1 + l2 + theta3)==y;
% 设r点为（0，0，0）
eq3=l0 - l1*sin(theta2) - l2*sin(theta2) - theta3*sin(theta2)==z;
[theta1,theta2,theta3]=solve([eq1,eq2,eq3],[theta1,theta2,theta3],'Real',true)